$(function () {
    ...
    function fadeInBurger() {
        ...
        $('footer').animate({marginLeft: '-40%', opacity: '0.4'}, '800');
    ...
    function fadeOutBurger() {
        ...
        $('footer').animate({marginLeft: '0px', opacity: '1'}, '800');
        $('nav').animate({marginRight: '-40%'}, '800');
        $('.opacBG').css({backgroundColor: 'white'}, '800');
        $('#burger2').css({marginTop: '15px'});
    }

    $('#hamburger').click(function () {
        $('#burger2').css({marginTop: '10px'});
        if (click == false) {
            fadeInBurger();
            click = true;
        } else {
